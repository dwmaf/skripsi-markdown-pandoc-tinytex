...
Berdasarkan tinjauan keempat penelitian di atas, terlihat adanya celah pengembangan. Penelitian-penelitian mengenai LSP sebelumnya [@sari2023] [@dahoklory2024] belum mengadopsi teknologi yang mampu memberikan pengalaman aplikasi *native*, sementara implementasi PWA [@putra2023] [@irawan2024] belum banyak diterapkan secara spesifik untuk memecahkan kompleksitas birokrasi pendaftaran sertifikasi. Oleh karena itu, penelitian ini hadir untuk menjembatani celah tersebut dengan mengembangkan Sistem Informasi LSP berbasis PWA, menggunakan kombinasi teknologi mutakhir Laravel dan Vue.js melalui pendekatan Inertia.js, guna menghasilkan sistem yang tidak hanya terpusat, tetapi juga memiliki interaktivitas dan aksesibilitas *mobile* yang tinggi.
