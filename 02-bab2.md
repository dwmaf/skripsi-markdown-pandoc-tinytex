...
1.  Dukungan *browser*: Tidak semua *browser* mendukung seluruh fitur PWA secara bersamaan. Misalnya, pada saat buku *Building Progressive Web Apps* karya Tal Ater diterbitkan, *browser* Safari belum mendukung *Service Worker*, meskipun aplikasi tetap dapat berjalan sebagai situs web biasa [@ater2017].
2.  Batasan Platform: Meskipun PWA membawa banyak fitur *native* ke *browser*, masih ada batasan akses ke perangkat keras tertentu dibandingkan dengan aplikasi *native* murni yang memiliki akses penuh ke API sistem operasi.
...
*Lighthouse* adalah sebuah perangkat lunak otomatis dan bersifat *open source* yang dirancang untuk membantu pengembang dalam meningkatkan kualitas halaman web. Alat pengujian ini memiliki fleksibilitas tinggi karena dapat dijalankan pada halaman web mana pun, baik yang bersifat publik maupun halaman yang memerlukan proses autentikasi. Lighthouse melakukan audit terhadap beberapa aspek krusial dari sebuah halaman web, *Performance, Accessibility, Best Practices,* dan *Search Engine Optimization* (SEO) [@chrome_lighthouse].
