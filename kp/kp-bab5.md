...
2. Optimalisasi sistem manajemen berkas pada *server* agar secara otomatis menghapus dokumen lama yang sudah berhasil dicetak guna menjaga kapasitas penyimpanan *server* tetap efisien.
